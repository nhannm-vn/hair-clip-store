  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Có lỗi xảy ra. Bạn thử tải lại trang hoặc quay về trang chủ nhé.
        </p>
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-full border border-input bg-background px-5 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-cream"
          >
            Về trang chủ
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Thịnh Phát — Kẹp Tóc & Phụ Kiện" },
      {
        name: "description",
        content:
          "Thịnh Phát giới thiệu nhiều mẫu kẹp tóc và phụ kiện tóc đa dạng. Xem sản phẩm và nhắn Zalo để đặt hàng.",
      },
      { property: "og:title", content: "Thịnh Phát — Kẹp Tóc & Phụ Kiện" },
      {
        property: "og:description",
        content: "Khám phá các mẫu kẹp tóc đa dạng và liên hệ Zalo để đặt hàng.",
      },
